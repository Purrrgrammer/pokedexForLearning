                    ...
                    <div className="pt-[50px]">
                        {pokemon.data && (
                            <div>
                                ...
                                {/* type name */}
                                <div>
                                    {pokemon.data.types.map(type => { return <p className={`badge-type-${type.type.name} px-[14px] capitalize py-1 w-full text-white font-semibold`} key={`typo-${pokemon.data?.id}`}>{type.type.name}</p> })}
                                </div>
                                <div>
                                    {
                                        (pokemon.data.id) < 9 ?
